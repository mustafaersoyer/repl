...
Variables are placeholders for content that you can then use anywhere in the AutoRepl. It's a very important concept to understand to truly create a customized experience for the user.
...
<img src="/img/variables/question.webp" width="800" alt="Iframe preview" />
...
`https://autorepl.com/my-bot?Email=test@test.com`
...
```js
AutoRepl.initBubble({
  url: `https://bot.autorepl.com/autorepl-support`,
  hiddenVariables: {
    'User ID': '123',
    'First name': 'John',
    Email: 'test@test.com',
...
<img src="/img/variables/declaring.webp" width="300" alt="Iframe preview" />
...
<img
  src="/img/variables/hiddenVariablesResults.webp"
  width="500"
  alt="Iframe preview"
/>
