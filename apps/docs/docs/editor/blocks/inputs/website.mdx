...
<FlowToBot
  flow={
    <img
      src="/img/blocks/inputs/website-flow.webp"
      width="100%"
  ...
  bot={
    <img
      src="/img/blocks/inputs/website-bot.webp"
      width="100%"
...
The retry message will be displayed whenever AutoRepl detected that the email is not properly formatted.
