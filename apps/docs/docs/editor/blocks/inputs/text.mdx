...
<FlowToBot
  flow={
    <img
      src="/img/blocks/inputs/short-text-flow.webp"
      width="100%"
  ...
  bot={
    <img
      src="/img/blocks/inputs/short-text-bot.webp"
      width="100%"
...
<FlowToBot
  flow={
    <img
      src="/img/blocks/inputs/long-text-flow.webp"
      width="100%"
      style={{ maxWidth: '500px' }}
  ...
  bot={
    <img
      src="/img/blocks/inputs/long-text-bot.webp"
      width="100%"
      style={{ maxWidth: '300px' }}
