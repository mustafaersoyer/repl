...
Blocks are the atomic building blocks of a bot chat. You can chain any blocks together to create complexe conversation flows. They are grouped into sub-categories to make it easier to find the right block for your needs:
...
<img
  src="/img/blocks/integrations.webp"
  width="100%"
  style={{ maxWidth: '300px' }}
