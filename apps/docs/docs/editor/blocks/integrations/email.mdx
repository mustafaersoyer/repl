...
<img
  src="/img/blocks/integrations/email.webp"
  width="400"
  alt="Email block example"
/>

By default, the email will be sent from notifications@autorepl.com with default content based on what your new lead has replied to. It will look like this:

<img
  src="/img/blocks/integrations/default-email.webp"
  alt="Email block example"
/>
