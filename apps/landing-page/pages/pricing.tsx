          ...
          <Stack align="center" spacing="12" w="full">
            <VStack>
              ...
              <Text maxW="900px" fontSize="xl" textAlign="center">
                ...
                , AutoRepl is here to help you build high-performing bots for
                the right price. Pay for as little or as much usage as you need.
              </Text>
            </VStack>
            ...
            >
              <StripeClimateLogo />
              <Text fontSize="sm">
                AutoRepl is contributing 1% of your subscription to remove CO₂
                from the atmosphere.{' '}
                <NextChakraLink
