...
const PrivacyPolicies = () => {
  return (
    <div className="flex flex-col items-center w-full overflow-x-hidden ">
      <SocialMetaTags currentUrl={`https://www.AutoRepl.io/terms-of-service`} />
      <Header />
      <Stack spacing={10} mx="auto" maxW="3xl" my="20">
        ...
        <p>
          By accessing this Website, accessible from https://www.autorepl.com,
        ...
        <p>
          ...
          materials on AutoRepl&apos;s Website for personal, non-commercial
        ...
        <p>
          This will let AutoRepl to terminate upon violations of any of these
        ...
        <p>
          All the materials on AutoRepl’s Website are provided &quot;as
          is&quot;. AutoRepl makes no warranties, may it be expressed or
          implied, therefore negates all other warranties. Furthermore, AutoRepl
        ...
        <p>
          AutoRepl or its suppliers will not be hold accountable for any damages
          that will arise with the use or inability to use the materials on
          AutoRepl’s Website, even if AutoRepl or an authorize representative of
        ...
        <p>
          The materials appearing on AutoRepl’s Website may include technical,
          typographical, or photographic errors. AutoRepl will not promise that
          any of the materials in this Website are accurate, complete, or
          current. AutoRepl may change the materials contained on its Website at
          any time without notice. AutoRepl does not make any commitment to
        ...
        <p>
          AutoRepl has not reviewed all of the sites linked to its Website and
          is not responsible for the contents of any such linked site. The
          presence of any link does not imply endorsement by AutoRepl of the
        ...
        <p>
          AutoRepl may revise these Terms of Use for its Website at any time
        ...
        <p>
          Any claim related to AutoRepl&apos;s Website shall be governed by the
