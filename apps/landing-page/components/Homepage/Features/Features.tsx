...
const features = [
  ...
  },
  {
    ...
    content: 'Invite your teammates to work on your bots with you',
  },
  {
    Icon: ConditionIcon,
    title: 'Link to sub bots.',
    content: 'Reuse your bots in different parent bots.',
  },
  {
    Icon: CalculatorIcon,
    title: 'Custom code',
  ...
  },
  {
    Icon: ShareIcon,
    title: 'Custom domain',
    content: 'Connect your bot to the custom URL of your choice',
  },
  {
    Icon: FolderIcon,
    title: 'Folder management',
    content:
      'Organize your bots in specific folders to keep it clean and work with multiple clients',
  },
]
      ...
      >
        <VStack>
          ...
          <Text
            ...
            data-aos="fade"
          >
            AutoRepl makes form building easy and comes with powerful features
          </Text>
        </VStack>
